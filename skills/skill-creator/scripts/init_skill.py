...
Examples:
    ...
    init_skill.py my-new-skill --path ~/.config/opencode/skills --resources scripts,references
    init_skill.py my-api-helper --path ~/.config/opencode/skills --resources scripts --examples
"""
